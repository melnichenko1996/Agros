...
<br>
    <form role="form" action="php/auth.php" method="post" name="form_auth" style="max-width: 330px;
                                                                                  padding: 10px; 
                                                                                  margin: 0 auto;
                                                                                  background: rgba(0, 0, 0, 0.8);
                                                                                  border-radius: 15px;
                                                                                  ">
        <h3 class="text-center" style="color: #f5f5f5;"><strong>АВТОРИЗАЦІЯ</strong></h3>
        <input type="email" class="form-control" name="email" required="required" placeholder="Введіть Email адресу:">
        <div id="valid_email_message" class="mesage_error"></div>
        <br>
        
        <input type="password" name="password" required="required" class="form-control" placeholder="Введіть пароль(мінімум 6 символів):">
        <div id="valid_password_message" class="mesage_error"></div>
        <br>
        ...
        <input type="submit" name="btn_submit_auth" value="АВТОРИЗУВАТИСЯ" class="btn btn-lg btn-success btn-block"><br>
        <a class="btn btn-lg btn-success btn-block" href="/form_register.php">ЗАРЕЄСТРУВАТИСЯ НА САЙТІ</a><br>
      </form>
</div>
<div class="col-md-3">
</div>
